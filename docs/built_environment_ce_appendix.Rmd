...
All files required to reproduce this article including analyses, plots, tables, and the text itself are available at [redacted], excepting restricted access data files. The necessary restricted files are documented in the replication repository readme.
