...
> Lanfear, Charles C. (2021). Collective Efficacy, Opportunity, and the Built Environment.

### How to cite

Please cite this compendium as:

> Lanfear, Charles C. (`r format(Sys.Date(), "%Y")`). _Repository of R code and data for 'Collective Efficacy, Opportunity, and the Built Environment'_. Accessed `r format(Sys.Date(), "%d %b %Y")`.
...
**Text and figures :**  [CC-BY-NC-SA-4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/)
